...
Сценарий: 01.19. Отчет Анализ обеспечения потребностей
	...
	* Проверяем, что строки плана обеспечены полностью
		...
		Тогда табличный документ "ОтчетТабличныйДокумент" равен:
			...
			| 'Королевство Севера [223]'                              | '2 582'      | '13 514 500' | ''              | ''      | ''             | ''      | ''                     | ''      | ''                 | ''      | ''                | ''      | ''                   | ''      | '2 582'      | '8 204 350' | '2 582'      | '8 204 350' |
			| 'Строка плана закупок 000000001 от 26.07.2023 12:40:22' | '950'        | '950 000'    | ''              | ''      | ''             | ''      | ''                     | ''      | ''                 | ''      | ''                | ''      | ''                   | ''      | '950'        | '570 000'   | '950'        | '570 000'   |
			| 'Материал1, т'                                          | '950'        | '950 000'    | ''              | ''      | ''             | ''      | ''                     | ''      | ''                 | ''      | ''                | ''      | ''                   | ''      | '950'        | '570 000'   | '950'        | '570 000'   |
			| 'Строка плана закупок 000000002 от 26.07.2023 12:40:35' | '300'        | '410 000'    | ''              | ''      | ''             | ''      | ''                     | ''      | ''                 | ''      | ''                | ''      | ''                   | ''      | '300'        | '350 000'   | '300'        | '350 000'   |
			| 'Материал2, т'                                          | '200'        | '260 000'    | ''              | ''      | ''             | ''      | ''                     | ''      | ''                 | ''      | ''                | ''      | ''                   | ''      | '200'        | '240 000'   | '200'        | '240 000'   |
			| 'Материал3, т'                                          | '100'        | '150 000'    | ''              | ''      | ''             | ''      | ''                     | ''      | ''                 | ''      | ''                | ''      | ''                   | ''      | '100'        | '110 000'   | '100'        | '110 000'   |
			| 'Строка плана закупок 000000003 от 26.07.2023 12:40:47' | '1 332'      | '12 154 500' | ''              | ''      | ''             | ''      | ''                     | ''      | ''                 | ''      | ''                | ''      | ''                   | ''      | '1 332'      | '7 284 350' | '1 332'      | '7 284 350' |
...
Сценарий: 01.20. Заявка на обеспечение 0000-0001 (Королевства Простора) 
...
Сценарий: 01.21. Заявка на обеспечение 0000-0002 (Королевство Дорна [223]) 
...
Сценарий: 01.22. СПЗ4 (по документу планирования, вручную)
...
Сценарий: 01.23. Лот4 (по документу планирования, вручную)

Сценарий: 01.24. Договор ДД4 (по документу планирования, вручную)

Сценарий: 01.25. Заказ поставщику (по документу планирования, вручную)

Сценарий: 01.26. Строка планов закупок 1 / запрос котировок		