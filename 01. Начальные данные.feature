...
Сценарий: 01.10. Протокол и договор ДД1 по закупочной процедуре 1
	...
	* 	Результаты работы комиссии
		...
		И в поле с именем 'РезультатРаботыКомиссии' я ввожу текст '+'
...
Сценарий: 01.11. Протокол и договор ДД2 по закупочной процедуре 2
...
Сценарий: 01.12. Протокол и договор ДД3 по закупочной процедуре 3
...
Сценарий: 01.13. ПТУ по договору ДД1
...
Сценарий: 01.14. ПТУ по договору ДД2
...
Сценарий: 01.15. ПТУ по договору ДД3-1 (поставщик: Поставщик4)
...
Сценарий: 01.16. ПТУ по договору ДД3-2 (поставщик: Поставщик5)
...
Сценарий: 01.17. Обеспечение потребностей Королевство Севера [223]
...
Сценарий: 01.18. Отчет Анализ обеспечения потребностей

	* Открываем отчет
	
		И В командном интерфейсе я выбираю 'Корпоративные закупки' 'Анализ обеспечения потребности'
		Тогда открылось окно 'Анализ обеспечения потребностей'
	...
	* Проверяем, что строки плана обеспечены полностью

		Тогда табличный документ "ОтчетТабличныйДокумент" равен:
			| 'Анализ обеспечения потребностей'                       | ''           | ''           | ''              | ''      | ''             | ''      | ''                     | ''      | ''                 | ''      | ''                | ''      | ''                   | ''      | ''           | ''          | ''           | ''          |
			| ''                                                      | ''           | ''           | ''              | ''      | ''             | ''      | ''                     | ''      | ''                 | ''      | ''                | ''      | ''                   | ''      | ''           | ''          | ''           | ''          |
			| 'Организация'                                           | 'ЗАЯВЛЕНО'   | ''           | 'В ОБЕСПЕЧЕНИИ' | ''      | 'План закупок' | ''      | 'Закупочные процедуры' | ''      | 'Выбран поставщик' | ''      | 'Законтрактовано' | ''      | 'Заказы поставщикам' | ''      | 'ИСПОЛНЕНО'  | ''          | 'ОБЕСПЕЧЕНО' | ''          |
			| 'ЦФО'                                                   | 'Количество' | 'Сумма'      | 'Количество'    | 'Сумма' | 'Количество'   | 'Сумма' | 'Количество'           | 'Сумма' | 'Количество'       | 'Сумма' | 'Количество'      | 'Сумма' | 'Количество'         | 'Сумма' | 'Количество' | 'Сумма'     | 'Количество' | 'Сумма'     |
			| 'Документ планирования'                                 | ''           | ''           | ''              | ''      | ''             | ''      | ''                     | ''      | ''                 | ''      | ''                | ''      | ''                   | ''      | ''           | ''          | ''           | ''          |
			| 'Номенклатура'                                          | ''           | ''           | ''              | ''      | ''             | ''      | ''                     | ''      | ''                 | ''      | ''                | ''      | ''                   | ''      | ''           | ''          | ''           | ''          |
			| 'Номенклатура потребностей'                             | ''           | ''           | ''              | ''      | ''             | ''      | ''                     | ''      | ''                 | ''      | ''                | ''      | ''                   | ''      | ''           | ''          | ''           | ''          |
			| 'Королевство Севера [223]'                              | '2 582'      | '13 514 500' | ''              | ''      | ''             | ''      | ''                     | ''      | ''                 | ''      | ''                | ''      | ''                   | ''      | '2 582'      | '8 204 350' | '2 582'      | '8 204 350' |
			| 'Королевство Севера [223]'                              | '2 582'      | '13 514 500' | ''              | ''      | ''             | ''      | ''                     | ''      | ''                 | ''      | ''                | ''      | ''                   | ''      | '2 582'      | '8 204 350' | '2 582'      | '8 204 350' |
			| 'Строка плана закупок 000000001 от 20.07.2023 14:03:46' | '950'        | '950 000'    | ''              | ''      | ''             | ''      | ''                     | ''      | ''                 | ''      | ''                | ''      | ''                   | ''      | '950'        | '570 000'   | '950'        | '570 000'   |
			| 'Материал1, т'                                          | '950'        | '950 000'    | ''              | ''      | ''             | ''      | ''                     | ''      | ''                 | ''      | ''                | ''      | ''                   | ''      | '950'        | '570 000'   | '950'        | '570 000'   |
			| 'Строка плана закупок 000000002 от 20.07.2023 14:24:46' | '300'        | '410 000'    | ''              | ''      | ''             | ''      | ''                     | ''      | ''                 | ''      | ''                | ''      | ''                   | ''      | '300'        | '350 000'   | '300'        | '350 000'   |
			| 'Материал2, т'                                          | '200'        | '260 000'    | ''              | ''      | ''             | ''      | ''                     | ''      | ''                 | ''      | ''                | ''      | ''                   | ''      | '200'        | '240 000'   | '200'        | '240 000'   |
			| 'Материал3, т'                                          | '100'        | '150 000'    | ''              | ''      | ''             | ''      | ''                     | ''      | ''                 | ''      | ''                | ''      | ''                   | ''      | '100'        | '110 000'   | '100'        | '110 000'   |
			| 'Строка плана закупок 000000003 от 20.07.2023 14:25:06' | '1 332'      | '12 154 500' | ''              | ''      | ''             | ''      | ''                     | ''      | ''                 | ''      | ''                | ''      | ''                   | ''      | '1 332'      | '7 284 350' | '1 332'      | '7 284 350' |
			| 'Товар1, кг'                                            | '555'        | '5 550 000'  | ''              | ''      | ''             | ''      | ''                     | ''      | ''                 | ''      | ''                | ''      | ''                   | ''      | '555'        | '679 850'   | '555'        | '679 850'   |
			| 'Товар2, упак'                                          | '777'        | '6 604 500'  | ''              | ''      | ''             | ''      | ''                     | ''      | ''                 | ''      | ''                | ''      | ''                   | ''      | '777'        | '6 604 500' | '777'        | '6 604 500' |
			| 'Итого'                                                 | '2 582'      | '13 514 500' | ''              | ''      | ''             | ''      | ''                     | ''      | ''                 | ''      | ''                | ''      | ''                   | ''      | '2 582'      | '8 204 350' | '2 582'      | '8 204 350' |
...
Сценарий: 01.19. Заявка на обеспечение 0000-0002 (Королевство Дорна [223]) 
...
Сценарий: 01.20. СПЗ4 (по документу планирования, вручную)
	...
	* Подбор потребности из заяки на обеспечение
		...
		И в таблице "СписокПотребностей" я перехожу к строке:
			| 'Организация заказчик'    | 'Единица измерения' | 'Цена'  | 'Документ планирования'                                  | 'ЦФО потребитель'         | 'Дата поставки' | 'Номенклатура'    | 'Место поставки' | 'Количество' | 'Сумма'  |
			| 'Королевство Дорна [223]' | 'л'                 | '54,00' | 'Заявка на обеспечение 0000-0002 от 24.07.2023 16:11:16' | 'Королевство Дорна [223]' | '24.07.2023'    | 'Топливо1, АИ-95' | 'МестоПоставки3' | '10,000'     | '540,00' |
...
Сценарий: 01.21. Лот4 (по документу планирования, вручную)

Сценарий: 01.22. Договор ДД4 (по документу планирования, вручную)

Сценарий: 01.23. Заказ поставщику (по документу планирования, вручную)
