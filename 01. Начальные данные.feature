...
Сценарий: 01.09. Закупочная процедура 3 / конкурс, зонтичная
	...
	* Создаем процедуру
		...
		И в таблице "Список" я перехожу к строке:
			| 'Валюта документа' | 'Заказчик'                 | 'Номер'     | 'Организатор закупки' |'Период закупок' | 'Предмет договора'                | 'Состояние' | 'Способ закупки' | 'Статус'    | 'Сумма документа' |
			| 'RUB'              | 'Королевство Севера [223]' | '000000003' | 'Семь королевств'     |'2022 г.'        | 'Приобретение материалов, тест 3' | 'Утвержден' | 'Конкурс'        | 'Утвержден' | '12 154 500,00'   |
	...
	* Закладка лоты
		...
		И в таблице "Лоты" я перехожу к строке:
			| 'Период закупок' | 'Вид закупки'       | 'Заказчик'                 | 'Метод оценки' | 'Предмет договора'                | 'НМЦ'                |
			| '2022 г.'        | 'Зонтичная закупка' | 'Королевство Севера [223]' | 'По ценам'     | 'Приобретение материалов, тест 3' | '12 154 500,00, RUB' |
