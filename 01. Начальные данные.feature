...
Сценарий: 01.12. Протокол и договор ДД3 по закупочной процедуре 3
	...
	* Дозаполняем договор	
		...
		И в поле с именем 'Номер' я ввожу текст 'ДД3'
		И я перехожу к следующему реквизиту
		И я нажимаю кнопку выбора у поля с именем "Дата"
		И в поле с именем 'Дата' я ввожу значение переменной "ТекущаяДата"
		И я перехожу к следующему реквизиту
	...
	* Записываем и проводим договор
		...
		И я нажимаю на кнопку с именем 'ФормаЗаписать'
		Тогда открылось окно 'ДД3 от * (С поставщиком) вер. * от *'
		И я нажимаю на кнопку с именем 'ФормаПровестиИЗакрыть'
		И я жду закрытия окна 'ДД3 от * (С поставщиком) вер. * от *' в течение 20 секунд
...
Сценарий: 01.15. ПТУ по договору ДД3 (поставщик: Поставщик5)
...
Сценарий: 01.16. ПТУ по договору ДД3 (поставщик: Поставщик4)
...
Сценарий: 01.17. Обеспечение потребностей Королевство Севера [223]
	...
	* Проверяем результат
		...
		Тогда таблица "Потребности" стала равной:
			| 'Аналитика номенклатуры' | 'Количество' |
			| 'Материал1, т'           | '250,000'    |
			| 'Материал1, т'           | '150,000'    |
			| 'Материал1, т'           | '450,000'    |
			| 'Материал1, т'           | '100,000'    |
...
Сценарий: 01.18. Отчет Анализ обеспечения потребностей
	...
	* Проверяем, что строки плана обеспечены полностью
		...
		# Тогда табличный документ "ОтчетТабличныйДокумент" равен:
			...
			# | ''                                                      | ''           | ''           | ''              | 
			# | 'Организация'                                           | 'ЗАЯВЛЕНО'   | ''           | 'В ОБЕСПЕЧЕНИИ' |
			# | 'ЦФО'                                                   | 'Количество' | 'Сумма'      | 'Количество'    |
			# | 'Документ планирования'                                 | ''           | ''           | ''              |
			# | 'Номенклатура'                                          | ''           | ''           | ''              |
			# | 'Номенклатура потребностей'                             | ''           | ''           | ''              | ''           | ''             | ''      | ''                     | ''           | ''                 | ''      | ''                | ''      | ''                   | ''      | ''           | ''        | ''           | ''        |
			# | 'Королевство Севера [223]'                              | '2 582'      | '13 514 500' | '1 332'         | '12 154 500' | ''             | ''      | '1 332'                | '12 154 500' | ''                 | ''      | ''                | ''      | ''                   | ''      | '1 250'      | '920 000' | '1 250'      | '920 000' |
			# | 'Королевство Севера [223]'                              | '2 582'      | '13 514 500' | '1 332'         | '12 154 500' | ''             | ''      | '1 332'                | '12 154 500' | ''                 | ''      | ''                | ''      | ''                   | ''      | '1 250'      | '920 000' | '1 250'      | '920 000' |
			...
			# | 'Строка плана закупок 000000003 от 20.07.2023 14:25:06' | '1 332'      | '12 154 500' | '1 332'         | '12 154 500' | ''             | ''      | '1 332'                | '12 154 500' | ''                 | ''      | ''                | ''      | ''                   | ''      | ''           | ''        | ''           | ''        |
			# | 'Товар1, кг'                                            | '555'        | '5 550 000'  | '555'           | '5 550 000'  | ''             | ''      | '555'                  | '5 550 000'  | ''                 | ''      | ''                | ''      | ''                   | ''      | ''           | ''        | ''           | ''        |
			# | 'Товар2, упак'                                          | '777'        | '6 604 500'  | '777'           | '6 604 500'  | ''             | ''      | '777'                  | '6 604 500'  | ''                 | ''      | ''                | ''      | ''                   | ''      | ''           | ''        | ''           | ''        |
			# | 'Итого'                                                 | '2 582'      | '13 514 500' | '1 332'         | '12 154 500' | ''             | ''      | '1 332'                | '12 154 500' | ''                 | ''      | ''                | ''      | ''                   | ''      | '1 250'      | '920 000' | '1 250'      | '920 000' |
