...
Сценарий: 01.11. Протокол и договор ДД1 по закупочной процедуре 1
	...
	* Открываем закупочную процедуру
		...
		И в таблице "Список" я перехожу к строке:
			...
			| 'Семь королевств'     | '2023 г.'        | 'Приобретение материалов, тест 1' | 'Запрос котировок' |
		И в таблице "Список" я выбираю текущую строку
		Тогда открылось окно 'Закупочная процедура №*'
...
Сценарий: 01.12. Протокол и договор ДД2 по закупочной процедуре 2
	...
	* Открываем закупочную процедуру
		...
		И в таблице "Список" я перехожу к строке:
			| 'Организатор закупки' | 'Период закупок' | 'Предмет договора'                | 'Способ закупки'     |
			| 'Семь королевств'     | '2023 г.'        | 'Приобретение материалов, тест 2' | 'Запрос предложений' |
		И в таблице "Список" я выбираю текущую строку
		Тогда открылось окно 'Закупочная процедура №*'
...
Сценарий: 01.13. Протокол и договор ДД3 по закупочной процедуре 3
	...
	* Открываем закупочную процедуру
		...
		И в таблице "Список" я перехожу к строке:
			| 'Организатор закупки' | 'Период закупок' | 'Предмет договора'                | 'Способ закупки' |
			| 'Семь королевств'     | '2023 г.'        | 'Приобретение материалов, тест 3' | 'Конкурс'        |
		И в таблице "Список" я выбираю текущую строку
...
Сценарий: 01.18. [Обеспечение потребностей] Королевство Севера
...
Сценарий: 01.19. [ЗАЯВКА -> ЗАКАЗ; Королевство Скал] Заявка на обеспечение
...
Сценарий: 01.20. [ЗАЯВКА -> ЗАКАЗ; Королевство Скал] Договор
...
Сценарий: 01.21. [ЗАЯВКА -> ЗАКАЗ; Королевство Скал] Заказ поставщику
...
Сценарий: 01.22. [ЗАЯВКА -> ЗАКАЗ; Королевство Скал] ПТУ
	...
	* Находим наш заказ
		...
		И в таблице "Список" я перехожу к строке:
			| 'Организация'      | 'Поставщик'  | 'Состояние оплаты'                      | 'Сумма документа' |
			| 'Королевство Скал' | 'Поставщик4' | 'Ожидает оплаты, В подготовке поставки' | '6 730 680,00'    |
...
Сценарий:01.23. [ЗАЯВКА -> ЗАКАЗ; Королевство Скал] Возврат поставщику
...
Сценарий: 01.24. [ЗАЯВКА -> СПЗ; Королевство Дорна] Заявка на обеспечение 
...
Сценарий: 01.25. [ЗАЯВКА -> СПЗ; Королевство Дорна] СПЗ
...
Сценарий: 01.26. [ЗАЯВКА -> ЛОТ;  Королевство простора] Заявка на обеспечение
...
Сценарий: 01.27. [ЗАЯВКА -> ЛОТ;  Королевство простора] Закупочная процедура 
...
Сценарий: 01.28. [ЗАЯВКА -> ДОГОВОР] Заявка на обеспечение Королевство Гор и Долин
...
Сценарий: 01.29. [ЗАЯВКА -> ДОГОВОР] Договор ДД5 Королевство Гор и Долин
