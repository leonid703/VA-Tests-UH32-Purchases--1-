...
Сценарий: 01.27. [ЗАЯВКА -> ДОГОВОР] Договор ДД5 Королевство Гор и Долин
	...
	* Добавляем товар вручную 
		...
		И я перехожу к следующему реквизиту
		И в таблице "ПланПоставокПоПериодам" я выбираю текущую строку
		И в таблице "ПланПоставокПоПериодам" в поле с именем 'ПланПоставокПоПериодамКоличество_37178cb4_8aa1_4319_b472_eee935df81ea' я ввожу текст '11,000'
