...
Сценарий: 01.19. [ЗАЯВКА -> ЗАКАЗ] Заявка на обеспечение 0000-0004 (Королевство Скал) 
	...
	* Проводим и закрываем открытые формы 
		...
		И я нажимаю на кнопку с именем 'ФормаЗаписать'
		Тогда открылось окно 'Заявка на обеспечение 0000-0004 от *'
		И я нажимаю на кнопку с именем 'ФормаПровести'
		И я нажимаю на кнопку с именем 'ФормаПровестиИЗакрыть'
		И я жду закрытия окна 'Заявка на обеспечение 0000-0004 от *' в течение 20 секунд
		Тогда открылось окно 'Заявка на обеспечение'
		И Я закрываю окно 'Заявка на обеспечение'

Сценарий: 01.20. [ЗАЯВКА -> ЗАКАЗ] Договор ДД5 Королевство Скал
	...
	* Закрываем все окна 
		...
		И я закрываю все окна приложения
		
Сценарий: 01.21. [ЗАЯВКА -> ЗАКАЗ] Заказ поставщику Королевство Скал
	...
	* Поставщик4	
		...
		И в таблице "Список" я перехожу к строке:
			...
			| '5602021624' | 'Поставщик4'               | 'Поставщик4'          |
		И в таблице "Список" я выбираю текущую строку
		Тогда открылось окно 'Заказ поставщику (создание) *'
	...
	* Договор ДД4
		...
		Тогда открылось окно 'Договоры'
		И в таблице "Список" я перехожу к строке:
			| 'Наименование'      | 'Вид договора'  | 'Номер договора' | 'Валюта' | 'Организация'      | 'Сумма'        |
			| 'ДД4 от 28.07.2023' | 'С поставщиком' | 'ДД4'            | 'RUB'    | 'Королевство Скал' | '1 000 000,00' |
		И в таблице "Список" я выбираю текущую строку
		Тогда открылось окно 'Заказ поставщику (создание) *'
	...
	* Проект3	
		...
		И в таблице "ПотребностиПоГодам" из выпадающего списка с именем "ПотребностиПоГодамПроект" я выбираю точное значение 'Проект3'
		И я перехожу к следующему реквизиту
...
Сценарий: 01.22. [ЗАЯВКА -> СПЗ] Заявка на обеспечение 0000-0002 Королевство Дорна [223]
...
Сценарий: 01.23. [ЗАЯВКА -> СПЗ] СПЗ 4 Королевство Дорна [223]
...
Сценарий: 01.24. [ЗАЯВКА -> ЛОТ] Заявка на обеспечение 0000-0001 (Королевства Простора) 
...
Сценарий: 01.25. [ЗАЯВКА -> ЛОТ] Закупочная процедура 4 Королевство простора 
...
Сценарий: 01.26. [ЗАЯВКА -> ДОГОВОР] Заявка на обеспечение 0000-0003 Королевство Гор и Долин
	...
	* Товар4 
		...
		И я перехожу к следующему реквизиту
		И в таблице "ПланыДокумента" я активизирую поле с именем "ПланыДокументаКоличество"
		И в таблице "ПланыДокумента" в поле с именем 'ПланыДокументаКоличество' я ввожу текст '55,000'
		И в таблице "ПланыДокумента" я завершаю редактирование строки
	...
	* Товар5
		...
		И я перехожу к следующему реквизиту
		И в таблице "ПланыДокумента" я активизирую поле с именем "ПланыДокументаКоличество"
		И в таблице "ПланыДокумента" в поле с именем 'ПланыДокументаКоличество' я ввожу текст '44,000'
		И в таблице "ПланыДокумента" я завершаю редактирование строки
 
	* Проводим и закрываем открытые формы 
	
		И я нажимаю на кнопку с именем 'ФормаЗаписать'
		Тогда открылось окно 'Заявка на обеспечение 0000-0003 от *'
		И я нажимаю на кнопку с именем 'ФормаПровести'
		И я нажимаю на кнопку с именем 'ФормаПровестиИЗакрыть'
		И я жду закрытия окна 'Заявка на обеспечение 0000-0003 от *' в течение 20 секунд
		Тогда открылось окно 'Заявка на обеспечение'
		И Я закрываю окно 'Заявка на обеспечение'
		
Сценарий: 01.27. [ЗАЯВКА -> ДОГОВОР] Договор ДД4 Королевство Гор и Долин