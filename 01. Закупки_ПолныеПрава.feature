...
Сценарий: 01.01. Корпоративные закупки (настройки)
	...
	* Заполняем настройки
		...
		И из выпадающего списка с именем "ВалютаУчетаЦентрализованныхЗакупок" я выбираю точное значение 'RUB'
		...
		И я Устанавливаю флаг с именем 'ИспользоватьКатегорийнуюМатрицуДляДоступаКПотребностям'
