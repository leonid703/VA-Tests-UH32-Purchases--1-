...
Сценарий: 02.01. [ЗАПРОС КОТИРОВОК] СПЗ 1
...
Сценарий: 02.02. [ЗАПРОС ПРЕДЛОЖЕНИЙ] СПЗ 2
...
Сценарий: 02.04. [ЗАПРОС КОТИРОВОК] Закупочная процедура 1 / лотовая
...
Сценарий: 02.05. [ЗАПРОС ПРЕДЛОЖЕНИЙ] Закупочная процедура 2 / попозиционная
...
Сценарий: 02.06. [КОНКУРС] Закупочная процедура 3 / зонтичная
...
Сценарий: 02.07. [ЗАПРОС КОТИРОВОК] Протокол и договор ДД1 по закупочной процедуре 1
...
Сценарий: 02.08. [ЗАПРОС ПРЕДЛОЖЕНИЙ] Протокол и договор ДД2 по закупочной процедуре 2
...
Сценарий: 02.08. [КОНКУРС] Протокол и договор ДД3 по закупочной процедуре 3
...
Сценарий: 02.09. [ЗАПРОС КОТИРОВОК] ПТУ по договору ДД1
...
Сценарий: 02.10. [ЗАПРОС ПРЕДЛОЖЕНИЙ] ПТУ по договору ДД2
...
Сценарий: 02.11. [КОНКУРС] ПТУ по договору ДД3-1 (поставщик: Поставщик4)
...
Сценарий: 02.12. [КОНКУРС] ПТУ по договору ДД3-2 (поставщик: Поставщик5)
